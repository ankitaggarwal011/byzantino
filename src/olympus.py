# -*- generated by 1.0.9 -*-
import da
PatternExpr_527 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_537 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key'), da.pat.FreePattern('request_num')])
PatternExpr_868 = da.pat.TuplePattern([da.pat.ConstantPattern('caught_up'), da.pat.ConstantPattern(None), da.pat.ConstantPattern(None)])
PatternExpr_913 = da.pat.TuplePattern([da.pat.ConstantPattern('wedge'), da.pat.FreePattern('hist'), da.pat.FreePattern('checkpt_proof'), da.pat.FreePattern('checkpoint'), da.pat.FreePattern('replica_id')])
PatternExpr_1090 = da.pat.TuplePattern([da.pat.ConstantPattern('caught_up'), da.pat.FreePattern('hash_running_state'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('most_recent_result')])
PatternExpr_1256 = da.pat.TuplePattern([da.pat.ConstantPattern('response_get_running_state'), da.pat.ConstantPattern(None), da.pat.ConstantPattern(None)])
PatternExpr_1282 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_1344 = da.pat.TuplePattern([da.pat.ConstantPattern('response_get_running_state'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('replica_running_state')])
PatternExpr_1828 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_1851 = da.pat.ConstantPattern('Shutdown')
PatternExpr_1835 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_1855 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_1265 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('response_get_running_state'), da.pat.ConstantPattern(None), da.pat.ConstantPattern(None)])])
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_527, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_526]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_537, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_536]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_868, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_913, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_912]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_1090, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1089]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_5', PatternExpr_1256, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_6', PatternExpr_1282, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1281]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_7', PatternExpr_1344, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1343]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_8', PatternExpr_1828, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_9', PatternExpr_1851, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, num_failures, all_replica_conf_failures, head_timeout, replica_timeout, checkpt_interval, **rest_1877):
        super().setup(name=name, num_replicas=num_replicas, num_failures=num_failures, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, checkpt_interval=checkpt_interval, **rest_1877)
    ...
    def run(self):
        ...
        super()._label('_st_label_1825', block=False)
        _st_label_1825 = 0
        while (_st_label_1825 == 0):
            _st_label_1825 += 1
            if PatternExpr_1835.match_iter(self._OlympusReceivedEvent_8, SELF_ID=self._id):
                _st_label_1825 += 1
            else:
                super()._label('_st_label_1825', block=True)
                _st_label_1825 -= 1
        super()._label('_st_label_1848', block=False)
        _st_label_1848 = 0
        while (_st_label_1848 == 0):
            _st_label_1848 += 1
            if PatternExpr_1855.match_iter(self._OlympusReceivedEvent_9, SELF_ID=self._id):
                _st_label_1848 += 1
            else:
                super()._label('_st_label_1848', block=True)
                _st_label_1848 -= 1
    ...
    def select_quorum(self):
        ...
        super()._label('_st_label_865', block=False)

        def ExistentialOpExpr_866():
            for (_, _, (_ConstantPattern885_, _ConstantPattern887_, _ConstantPattern889_)) in self._OlympusReceivedEvent_2:
                if (_ConstantPattern885_ == 'caught_up'):
                    if (_ConstantPattern887_ == None):
        ...
        _st_label_865 = 0
        self._timer_start()
        while (_st_label_865 == 0):
            _st_label_865 += 1
            if ExistentialOpExpr_866():
                pass
                _st_label_865 += 1
                ...
                super()._label('_st_label_865', block=True, timeout=2)
                _st_label_865 -= 1
    ...
    def get_running_state_from_quorum(self):
        ...
        for each_member in self._state.quorum:
            if (not self._state.running_state_validated):
                ...
                super()._label('_st_label_1253', block=False)
                _st_label_1253 = 0
                while (_st_label_1253 == 0):
                    _st_label_1253 += 1
                    if PatternExpr_1265.match_iter(self._OlympusReceivedEvent_5, SELF_ID=self._id):
                        _st_label_1253 += 1
                    else:
                        super()._label('_st_label_1253', block=True)
                        _st_label_1253 -= 1
                else:
                    if (_st_label_1253 != 2):
                        continue
    ...
    def _Olympus_handler_526(self, sender):
        pass
    _Olympus_handler_526._labels = None
    _Olympus_handler_526._notlabels = None

    def _Olympus_handler_536(self, client, client_name, client_id, client_public_key, request_num):
    ...
    _Olympus_handler_536._labels = None
    _Olympus_handler_536._notlabels = None

    def _Olympus_handler_912(self, hist, checkpt_proof, checkpoint, replica_id):
        ...
        if (len(self._state.wedged_responses) == (self._state.num_failures + 1)):
            ...
            self.select_quorum()
    _Olympus_handler_912._labels = None
    _Olympus_handler_912._notlabels = None

    def _Olympus_handler_1089(self, hash_running_state, replica_id, most_recent_result):
    ...
    _Olympus_handler_1089._labels = None
    _Olympus_handler_1089._notlabels = None

    def _Olympus_handler_1281(self, sender, proof_of_misbehavior):
    ...
    _Olympus_handler_1281._labels = None
    _Olympus_handler_1281._notlabels = None

    def _Olympus_handler_1343(self, replica_id, replica_running_state):
    ...
    _Olympus_handler_1343._labels = None
    _Olympus_handler_1343._notlabels = None
