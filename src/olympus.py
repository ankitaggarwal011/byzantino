# -*- generated by 1.0.11 -*-
import da
PatternExpr_531 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_541 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key'), da.pat.FreePattern('request_num')])
PatternExpr_889 = da.pat.TuplePattern([da.pat.ConstantPattern('caught_up'), da.pat.ConstantPattern(None), da.pat.ConstantPattern(None)])
PatternExpr_934 = da.pat.TuplePattern([da.pat.ConstantPattern('wedge'), da.pat.FreePattern('hist'), da.pat.FreePattern('checkpt_proof'), da.pat.FreePattern('checkpoint'), da.pat.FreePattern('replica_id')])
PatternExpr_1150 = da.pat.TuplePattern([da.pat.ConstantPattern('caught_up'), da.pat.FreePattern('hash_running_state'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('most_recent_result')])
PatternExpr_1316 = da.pat.BoundPattern('_BoundPattern1324_')
PatternExpr_1341 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_1437 = da.pat.TuplePattern([da.pat.ConstantPattern('response_get_running_state'), da.pat.FreePattern('replica_id'), da.pat.FreePattern('replica_running_state')])
PatternExpr_1915 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_1938 = da.pat.ConstantPattern('Shutdown')
PatternExpr_1922 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_1942 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_1326 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1333_')])
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_531, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_530]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_541, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_540]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_889, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_934, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_933]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_1150, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1149]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_5', PatternExpr_1316, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_6', PatternExpr_1341, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1340]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_7', PatternExpr_1437, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1436]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_8', PatternExpr_1915, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_9', PatternExpr_1938, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, num_failures, all_replica_conf_failures, head_timeout, replica_timeout, checkpt_interval, **rest_1964):
        super().setup(name=name, num_replicas=num_replicas, num_failures=num_failures, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, checkpt_interval=checkpt_interval, **rest_1964)
    ...
    def run(self):
        ...
        super()._label('_st_label_1912', block=False)
        _st_label_1912 = 0
        while (_st_label_1912 == 0):
            _st_label_1912 += 1
            if PatternExpr_1922.match_iter(self._OlympusReceivedEvent_8, SELF_ID=self._id):
                _st_label_1912 += 1
            else:
                super()._label('_st_label_1912', block=True)
                _st_label_1912 -= 1
        super()._label('_st_label_1935', block=False)
        _st_label_1935 = 0
        while (_st_label_1935 == 0):
            _st_label_1935 += 1
            if PatternExpr_1942.match_iter(self._OlympusReceivedEvent_9, SELF_ID=self._id):
                _st_label_1935 += 1
            else:
                super()._label('_st_label_1935', block=True)
                _st_label_1935 -= 1
    ...
    def select_quorum(self):
        ...
        def ExistentialOpExpr_887():
            for (_, _, (_ConstantPattern906_, _ConstantPattern908_, _ConstantPattern910_)) in self._OlympusReceivedEvent_2:
                if (_ConstantPattern906_ == 'caught_up'):
                    if (_ConstantPattern908_ == None):
                        if (_ConstantPattern910_ == None):
        ...
        while (_st_label_886 == 0):
            ...
            if ExistentialOpExpr_887():
                ...
                super()._label('_st_label_886', block=True, timeout=2)
                _st_label_886 -= 1
    ...
    def get_running_state_from_quorum(self):
        ...
        for each_member in self._state.quorum:
            if (not self._state.running_state_validated):
                ...
                super()._label('_st_label_1313', block=False)
                _st_label_1313 = 0
                while (_st_label_1313 == 0):
                    _st_label_1313 += 1
                    if PatternExpr_1326.match_iter(self._OlympusReceivedEvent_5, _BoundPattern1333_=('response_get_running_state_' + str(each_member[1])), SELF_ID=self._id):
                        _st_label_1313 += 1
                    else:
                        super()._label('_st_label_1313', block=True)
                        _st_label_1313 -= 1
                else:
                    if (_st_label_1313 != 2):
                        continue
    ...
    def _Olympus_handler_530(self, sender):
        pass
    _Olympus_handler_530._labels = None
    _Olympus_handler_530._notlabels = None

    def _Olympus_handler_540(self, client, client_name, client_id, client_public_key, request_num):
    ...
    _Olympus_handler_540._labels = None
    _Olympus_handler_540._notlabels = None

    def _Olympus_handler_933(self, hist, checkpt_proof, checkpoint, replica_id):
        ...
        if (len(self._state.wedged_responses) == (self._state.num_failures + 1)):
            ...
            self.select_quorum()
    _Olympus_handler_933._labels = None
    _Olympus_handler_933._notlabels = None

    def _Olympus_handler_1149(self, hash_running_state, replica_id, most_recent_result):
    ...
    _Olympus_handler_1149._labels = None
    _Olympus_handler_1149._notlabels = None

    def _Olympus_handler_1340(self, sender, proof_of_misbehavior):
        ...
        if (isinstance(proof_of_misbehavior, list) and (len(proof_of_misbehavior) == 2)):
            (r_shuttle_signed, r_shuttle) = proof_of_misbehavior
            if (r_shuttle == None):
                self.output_wrapper((('Reconfiguration request sent by ' + str(sender)) + " is valid. Tail's signature is invalid. Starting reconfiguration."))
                self.begin_reconfiguration()
        elif ((isinstance(proof_of_misbehavior, int) and (proof_of_misbehavior == self._state.configuration_number)) or (isinstance(proof_of_misbehavior, list) and self.validate_proof_of_misbehavior(proof_of_misbehavior))):
    ...
    _Olympus_handler_1340._labels = None
    _Olympus_handler_1340._notlabels = None

    def _Olympus_handler_1436(self, replica_id, replica_running_state):
        ...
        if (self.calculate_hash(replica_running_state) == self._state.chosen_running_state):
            ...
            self.output_wrapper((('Running state of Replica ' + str(replica_id)) + ' is not validated with the quorum. Trying the next replica.'))
