# -*- generated by 1.0.9 -*-
import da
PatternExpr_375 = da.pat.ConstantPattern('Shutdown')
PatternExpr_379 = da.pat.BoundPattern('_BoundPattern380_')
PatternExpr_393 = da.pat.ConstantPattern('Shutdown')
PatternExpr_397 = da.pat.FreePattern('olympus')
PatternExpr_411 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('olympus_'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_'), da.pat.FreePattern('tail_'), da.pat.FreePattern('config_data')])
PatternExpr_484 = da.pat.TuplePattern([da.pat.ConstantPattern('Key'), da.pat.FreePattern('private_key_')])
PatternExpr_491 = da.pat.FreePattern('olympus')
PatternExpr_511 = da.pat.TuplePattern([da.pat.ConstantPattern('Client_keys'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_536 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Request'), da.pat.FreePattern('type'), da.pat.FreePattern('request_from'), da.pat.FreePattern('client'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('args')])
PatternExpr_733 = da.pat.BoundPattern('_BoundPattern739_')
PatternExpr_969 = da.pat.BoundPattern('_BoundPattern975_')
PatternExpr_1272 = da.pat.BoundPattern('_BoundPattern1278_')
PatternExpr_1311 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Result_shuttle'), da.pat.FreePattern('request_from'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_381 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern387_')]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_741 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern748_')])
PatternExpr_977 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern984_')])
PatternExpr_1280 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1287_')])
PatternExpr_2168 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_2187 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_2253 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_2369 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_2392 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2376 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_2396 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_2509 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_')])
PatternExpr_2518 = da.pat.FreePattern('olympus')
PatternExpr_2541 = da.pat.TuplePattern([da.pat.ConstantPattern('Keys'), da.pat.FreePattern('replica_public_keys_'), da.pat.FreePattern('olympus_public_key_')])
PatternExpr_2550 = da.pat.FreePattern('olympus')
PatternExpr_2586 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Operation_result'), da.pat.FreePattern('request_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_2767 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2770_'), da.pat.BoundPattern('_BoundPattern2771_')])
PatternExpr_2821 = da.pat.BoundPattern('_BoundPattern2827_')
PatternExpr_2893 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2774 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2784_'), da.pat.BoundPattern('_BoundPattern2785_')])])
PatternExpr_2829 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern2836_')])
PatternExpr_2897 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_375, sources=[PatternExpr_379], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_393, sources=[PatternExpr_397], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_392]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_411, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_410]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_484, sources=[PatternExpr_491], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_483]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_511, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_510]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_536, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_535]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_733, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_969, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_1272, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_1311, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_1310])])

    def setup(self, id, name, replica_failures, replica_timeout, olympus_public_key, **rest_3456):
        super().setup(id=id, name=name, replica_failures=replica_failures, replica_timeout=replica_timeout, olympus_public_key=olympus_public_key, **rest_3456)
        self._state.id = id
    ...
    def run(self):
        ...
        super()._label('_st_label_372', block=False)
        _st_label_372 = 0
        while (_st_label_372 == 0):
            _st_label_372 += 1
            if PatternExpr_381.match_iter(self._ReplicaReceivedEvent_0, _BoundPattern387_=self._state.olympus, SELF_ID=self._id):
                _st_label_372 += 1
            else:
                super()._label('_st_label_372', block=True)
                _st_label_372 -= 1
    ...
    def _Replica_handler_392(self, olympus):
    ...
    def _Replica_handler_410(self, olympus_, replicas_, head_, tail_, config_data):
    ...
    _Replica_handler_410._labels = None
    _Replica_handler_410._notlabels = None

    def _Replica_handler_483(self, private_key_, olympus):
    ...
    _Replica_handler_483._labels = None
    _Replica_handler_483._notlabels = None

    def _Replica_handler_510(self, client_id, client_public_key):
    ...
    def _Replica_handler_535(self, sender_id, type, request_from, client, request_id, client_id, args):
        ...
        if (self._state.status == 1):
            if (request_from == client):
                ...
                if (request_id in self._state.result_cache):
                    ...
                    while (_st_label_730 == 0):
                        _st_label_730 += 1
                        if PatternExpr_741.match_iter(self._ReplicaReceivedEvent_6, _BoundPattern748_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                            pass
                            _st_label_730 += 1
                            ...
                            super()._label('_st_label_730', block=True, timeout=self._state.replica_timeout)
                            _st_label_730 -= 1
                    return
            else:
            ...
            if (self._id == self._state.head):
                ...
                super()._label('_st_label_966', block=False)
                _st_label_966 = 0
                self._timer_start()
                while (_st_label_966 == 0):
                    _st_label_966 += 1
                    if PatternExpr_977.match_iter(self._ReplicaReceivedEvent_7, _BoundPattern984_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                        pass
                        _st_label_966 += 1
                    elif self._timer_expired:
                        self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                        ...
                        super()._label('_st_label_966', block=True, timeout=self._state.replica_timeout)
                        _st_label_966 -= 1
            else:
                ...
                if self.validate_shuttle(args):
                    ...
                    if (self._id == self._state.tail):
                        ...
                        self.sign_and_send(('Request', type, self._id, client, request_id, client_id, shuttle), self._state.replicas[(self._state.id + 1)])
                        super()._label('_st_label_1269', block=False)
                        _st_label_1269 = 0
                        self._timer_start()
                        while (_st_label_1269 == 0):
                            _st_label_1269 += 1
                            if PatternExpr_1280.match_iter(self._ReplicaReceivedEvent_8, _BoundPattern1287_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                                pass
                                _st_label_1269 += 1
                            elif self._timer_expired:
                                self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                                ...
                                super()._label('_st_label_1269', block=True, timeout=self._state.replica_timeout)
                                _st_label_1269 -= 1
                else:
                    self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_535._labels = None
    _Replica_handler_535._notlabels = None

    def _Replica_handler_1310(self, sender_id, request_from, request_id, client_id, result_shuttle):
        ...
        if self.validate_result_shuttle(result_shuttle):
            ...
            self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_1310._labels = None
    _Replica_handler_1310._notlabels = None
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_2168, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2167]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_2187, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2186]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_2253, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2252]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_2369, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_2392, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, all_replica_conf_failures, head_timeout, replica_timeout, **rest_3456):
        super().setup(name=name, num_replicas=num_replicas, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, **rest_3456)
        self._state.name = name
    ...
    def run(self):
        ...
        super()._label('_st_label_2366', block=False)
        _st_label_2366 = 0
        while (_st_label_2366 == 0):
            _st_label_2366 += 1
            if PatternExpr_2376.match_iter(self._OlympusReceivedEvent_3, SELF_ID=self._id):
                _st_label_2366 += 1
            else:
                super()._label('_st_label_2366', block=True)
                _st_label_2366 -= 1
        super()._label('_st_label_2389', block=False)
        _st_label_2389 = 0
        while (_st_label_2389 == 0):
            _st_label_2389 += 1
            if PatternExpr_2396.match_iter(self._OlympusReceivedEvent_4, SELF_ID=self._id):
                _st_label_2389 += 1
            else:
                super()._label('_st_label_2389', block=True)
                _st_label_2389 -= 1
    ...
    def _Olympus_handler_2167(self, sender):
        self.output_wrapper((('ACK from ' + str(sender)) + '.'))
    _Olympus_handler_2167._labels = None
    _Olympus_handler_2167._notlabels = None

    def _Olympus_handler_2186(self, client, client_name, client_id, client_public_key):
        self._state.client_keys[client_id] = VerifyKey(client_public_key, encoder=HexEncoder)
    ...
    _Olympus_handler_2186._labels = None
    _Olympus_handler_2186._notlabels = None

    def _Olympus_handler_2252(self, sender, proof_of_misbehavior):
    ...
    _Olympus_handler_2252._labels = None
    _Olympus_handler_2252._notlabels = None
...
class Client(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_0', PatternExpr_2509, sources=[PatternExpr_2518], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2508]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_1', PatternExpr_2541, sources=[PatternExpr_2550], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2540]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_2', PatternExpr_2586, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2585]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_3', PatternExpr_2767, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_4', PatternExpr_2821, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_5', PatternExpr_2893, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, client_id, olympus, request_id, client_timeout, operations, num_failures, **rest_3456):
        super().setup(client_id=client_id, olympus=olympus, request_id=request_id, client_timeout=client_timeout, operations=operations, num_failures=num_failures, **rest_3456)
    ...
    def run(self):
        if (self._state.replicas is None):
            ...
            super()._label('_st_label_2764', block=False)
            _st_label_2764 = 0
            while (_st_label_2764 == 0):
                _st_label_2764 += 1
                if PatternExpr_2774.match_iter(self._ClientReceivedEvent_3, _BoundPattern2784_=self._state.replicas, _BoundPattern2785_=self._state.head, SELF_ID=self._id):
                    _st_label_2764 += 1
                else:
                    super()._label('_st_label_2764', block=True)
                    _st_label_2764 -= 1
        for op in self._state.operations:
            ...
            while True:
                ...
                super()._label('_st_label_2818', block=False)
                _st_label_2818 = 0
                self._timer_start()
                while (_st_label_2818 == 0):
                    _st_label_2818 += 1
                    if PatternExpr_2829.match_iter(self._ClientReceivedEvent_4, _BoundPattern2836_=('Operation_result_' + str(self._state.request_id)), SELF_ID=self._id):
                        break
                        _st_label_2818 += 1
                    elif self._timer_expired:
                        ...
                        super()._label('_st_label_2818', block=True, timeout=self._state.client_timeout)
                        _st_label_2818 -= 1
                else:
                    if (_st_label_2818 != 2):
                        continue
        ...
        super()._label('_st_label_2890', block=False)
        _st_label_2890 = 0
        while (_st_label_2890 == 0):
            _st_label_2890 += 1
            if PatternExpr_2897.match_iter(self._ClientReceivedEvent_5, SELF_ID=self._id):
                _st_label_2890 += 1
            else:
                super()._label('_st_label_2890', block=True)
                _st_label_2890 -= 1
    ...
    def _Client_handler_2508(self, replicas_, head_, olympus):
        self._state.replicas = replicas_
        self._state.head = head_
        self.output_wrapper((self._state.name + ' is configured.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2508._labels = None
    _Client_handler_2508._notlabels = None

    def _Client_handler_2540(self, replica_public_keys_, olympus_public_key_, olympus):
        self._state.replica_public_keys = [VerifyKey(key, encoder=HexEncoder) for key in replica_public_keys_]
        ...
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2540._labels = None
    _Client_handler_2540._notlabels = None

    def _Client_handler_2585(self, sender_id, request_id, result_shuttle):
        result_shuttle = self.verify_data_with_key(result_shuttle, self._state.replica_public_keys[sender_id])
        if (result_shuttle == None):
            self.output_wrapper((('Verification of message sent by Replica ' + str(sender_id)) + ' has failed.'))
            return
    ...
    _Client_handler_2585._labels = None
    _Client_handler_2585._notlabels = None
