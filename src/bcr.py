# -*- generated by 1.0.9 -*-
import da
PatternExpr_366 = da.pat.ConstantPattern('Shutdown')
PatternExpr_370 = da.pat.BoundPattern('_BoundPattern371_')
PatternExpr_384 = da.pat.ConstantPattern('Shutdown')
PatternExpr_388 = da.pat.FreePattern('olympus')
PatternExpr_402 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('olympus_'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_'), da.pat.FreePattern('tail_'), da.pat.FreePattern('config_data')])
PatternExpr_475 = da.pat.TuplePattern([da.pat.ConstantPattern('Key'), da.pat.FreePattern('private_key_')])
PatternExpr_482 = da.pat.FreePattern('olympus')
PatternExpr_502 = da.pat.TuplePattern([da.pat.ConstantPattern('Client_keys'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_527 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Request'), da.pat.FreePattern('type'), da.pat.FreePattern('request_from'), da.pat.FreePattern('client'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('args')])
PatternExpr_718 = da.pat.BoundPattern('_BoundPattern724_')
PatternExpr_930 = da.pat.BoundPattern('_BoundPattern936_')
PatternExpr_1208 = da.pat.BoundPattern('_BoundPattern1214_')
PatternExpr_1247 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Result_shuttle'), da.pat.FreePattern('request_from'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_372 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern378_')]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_726 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern733_')])
PatternExpr_938 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern945_')])
PatternExpr_1216 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1223_')])
PatternExpr_2037 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_2056 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_2109 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_2225 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_2248 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2232 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_2252 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_2359 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_')])
PatternExpr_2368 = da.pat.FreePattern('olympus')
PatternExpr_2391 = da.pat.TuplePattern([da.pat.ConstantPattern('Keys'), da.pat.FreePattern('replica_public_keys_')])
PatternExpr_2398 = da.pat.FreePattern('olympus')
PatternExpr_2426 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Operation_result'), da.pat.FreePattern('result_shuttle')])
PatternExpr_2600 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2603_'), da.pat.BoundPattern('_BoundPattern2604_')])
PatternExpr_2654 = da.pat.BoundPattern('_BoundPattern2660_')
PatternExpr_2707 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2607 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2617_'), da.pat.BoundPattern('_BoundPattern2618_')])])
PatternExpr_2662 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern2669_')])
PatternExpr_2711 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
_config_object = {}
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_366, sources=[PatternExpr_370], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_384, sources=[PatternExpr_388], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_383]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_402, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_401]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_475, sources=[PatternExpr_482], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_474]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_502, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_501]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_527, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_526]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_718, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_930, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_1208, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_1247, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_1246])])

    def setup(self, id, name, replica_failures, replica_timeout, olympus_public_key, **rest_3229):
        super().setup(id=id, name=name, replica_failures=replica_failures, replica_timeout=replica_timeout, olympus_public_key=olympus_public_key, **rest_3229)
        self._state.id = id
    ...
    def run(self):
        ...
        while (_st_label_363 == 0):
            _st_label_363 += 1
            if PatternExpr_372.match_iter(self._ReplicaReceivedEvent_0, _BoundPattern378_=self._state.olympus, SELF_ID=self._id):
                _st_label_363 += 1
            else:
    ...
    def _Replica_handler_383(self, olympus):
        self._state.status = 2
        self.output_wrapper((self._state.name + ' is immutable and shutting down.'))
    _Replica_handler_383._labels = None
    _Replica_handler_383._notlabels = None

    def _Replica_handler_401(self, olympus_, replicas_, head_, tail_, config_data):
    ...
    def _Replica_handler_474(self, private_key_, olympus):
    ...
    _Replica_handler_474._labels = None
    _Replica_handler_474._notlabels = None

    def _Replica_handler_501(self, client_id, client_public_key):
        self._state.client_keys[client_id] = VerifyKey(client_public_key, encoder=HexEncoder)
        self.send(('ACK', self._state.name), to=self._state.olympus)
    _Replica_handler_501._labels = None
    _Replica_handler_501._notlabels = None

    def _Replica_handler_526(self, sender_id, type, request_from, client, request_id, client_id, args):
        ...
        if (self._state.status == 1):
            if (request_from == client):
                ...
                if (request_id in self._state.result_cache):
                    ...
                    super()._label('_st_label_715', block=False)
                    _st_label_715 = 0
                    self._timer_start()
                    while (_st_label_715 == 0):
                        _st_label_715 += 1
                        if PatternExpr_726.match_iter(self._ReplicaReceivedEvent_6, _BoundPattern733_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                            pass
                            _st_label_715 += 1
                            ...
                            super()._label('_st_label_715', block=True, timeout=self._state.replica_timeout)
                            _st_label_715 -= 1
                    return
            else:
            ...
            if (self._id == self._state.head):
                ...
                while (_st_label_927 == 0):
                    _st_label_927 += 1
                    if PatternExpr_938.match_iter(self._ReplicaReceivedEvent_7, _BoundPattern945_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                        pass
                        _st_label_927 += 1
                    elif self._timer_expired:
                        self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                        ...
                        super()._label('_st_label_927', block=True, timeout=self._state.replica_timeout)
                        _st_label_927 -= 1
            else:
                ...
                if self.validate_shuttle(args):
                    ...
                    if (self._id == self._state.tail):
                        ...
                        self.sign_and_send(('Request', type, self._id, client, request_id, client_id, shuttle), self._state.replicas[(self._state.id + 1)])
                        super()._label('_st_label_1205', block=False)
                        _st_label_1205 = 0
                        self._timer_start()
                        while (_st_label_1205 == 0):
                            _st_label_1205 += 1
                            if PatternExpr_1216.match_iter(self._ReplicaReceivedEvent_8, _BoundPattern1223_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                                pass
                                _st_label_1205 += 1
                            elif self._timer_expired:
                                self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                                ...
                                super()._label('_st_label_1205', block=True, timeout=self._state.replica_timeout)
                                _st_label_1205 -= 1
                else:
                    self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_526._labels = None
    _Replica_handler_526._notlabels = None

    def _Replica_handler_1246(self, sender_id, request_from, request_id, client_id, result_shuttle):
        ...
        if self.validate_result_shuttle(result_shuttle):
            ...
            self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_1246._labels = None
    _Replica_handler_1246._notlabels = None
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_2037, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2036]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_2056, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2055]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_2109, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2108]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_2225, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_2248, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, all_replica_conf_failures, head_timeout, replica_timeout, **rest_3229):
        super().setup(name=name, num_replicas=num_replicas, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, **rest_3229)
        self._state.name = name
    ...
    def run(self):
        ...
        super()._label('_st_label_2222', block=False)
        _st_label_2222 = 0
        while (_st_label_2222 == 0):
            _st_label_2222 += 1
            if PatternExpr_2232.match_iter(self._OlympusReceivedEvent_3, SELF_ID=self._id):
                _st_label_2222 += 1
            else:
                super()._label('_st_label_2222', block=True)
                _st_label_2222 -= 1
        super()._label('_st_label_2245', block=False)
        _st_label_2245 = 0
        while (_st_label_2245 == 0):
            _st_label_2245 += 1
            if PatternExpr_2252.match_iter(self._OlympusReceivedEvent_4, SELF_ID=self._id):
                _st_label_2245 += 1
            else:
    ...
    def _Olympus_handler_2036(self, sender):
        self.output_wrapper((('ACK from ' + str(sender)) + '.'))
    _Olympus_handler_2036._labels = None
    _Olympus_handler_2036._notlabels = None

    def _Olympus_handler_2055(self, client, client_name, client_id, client_public_key):
        self._state.client_keys[client_id] = VerifyKey(client_public_key, encoder=HexEncoder)
    ...
    _Olympus_handler_2055._labels = None
    _Olympus_handler_2055._notlabels = None

    def _Olympus_handler_2108(self, sender, proof_of_misbehavior):
    ...
    _Olympus_handler_2108._labels = None
    _Olympus_handler_2108._notlabels = None
...
class Client(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_0', PatternExpr_2359, sources=[PatternExpr_2368], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2358]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_1', PatternExpr_2391, sources=[PatternExpr_2398], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2390]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_2', PatternExpr_2426, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2425]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_3', PatternExpr_2600, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_4', PatternExpr_2654, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_5', PatternExpr_2707, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, client_id, olympus, request_id, client_timeout, operations, num_failures, **rest_3229):
        super().setup(client_id=client_id, olympus=olympus, request_id=request_id, client_timeout=client_timeout, operations=operations, num_failures=num_failures, **rest_3229)
    ...
    def run(self):
        if (self._state.replicas is None):
            ...
            super()._label('_st_label_2597', block=False)
            _st_label_2597 = 0
            while (_st_label_2597 == 0):
                _st_label_2597 += 1
                if PatternExpr_2607.match_iter(self._ClientReceivedEvent_3, _BoundPattern2617_=self._state.replicas, _BoundPattern2618_=self._state.head, SELF_ID=self._id):
                    _st_label_2597 += 1
                else:
                    super()._label('_st_label_2597', block=True)
                    _st_label_2597 -= 1
        for op in self._state.operations:
            ...
            while True:
                ...
                super()._label('_st_label_2651', block=False)
                _st_label_2651 = 0
                self._timer_start()
                while (_st_label_2651 == 0):
                    _st_label_2651 += 1
                    if PatternExpr_2662.match_iter(self._ClientReceivedEvent_4, _BoundPattern2669_=('Operation_result_' + str(self._state.request_id)), SELF_ID=self._id):
                        break
                        _st_label_2651 += 1
                    elif self._timer_expired:
                        ...
                        super()._label('_st_label_2651', block=True, timeout=self._state.client_timeout)
                        _st_label_2651 -= 1
                else:
                    if (_st_label_2651 != 2):
                        continue
        ...
        super()._label('_st_label_2704', block=False)
        _st_label_2704 = 0
        while (_st_label_2704 == 0):
            _st_label_2704 += 1
            if PatternExpr_2711.match_iter(self._ClientReceivedEvent_5, SELF_ID=self._id):
                _st_label_2704 += 1
            else:
                super()._label('_st_label_2704', block=True)
                _st_label_2704 -= 1
    ...
    def _Client_handler_2358(self, replicas_, head_, olympus):
        self._state.replicas = replicas_
        self._state.head = head_
        self.output_wrapper((self._state.name + ' is configured.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2358._labels = None
    _Client_handler_2358._notlabels = None

    def _Client_handler_2390(self, replica_public_keys_, olympus):
        self._state.replica_public_keys = [VerifyKey(key, encoder=HexEncoder) for key in replica_public_keys_]
        self.output_wrapper((self._state.name + ' received the public keys of replicas from Olympus.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2390._labels = None
    _Client_handler_2390._notlabels = None

    def _Client_handler_2425(self, sender_id, result_shuttle):
        result_shuttle = self.verify_data_with_key(result_shuttle, self._state.replica_public_keys[sender_id])
        if (result_shuttle == None):
            self.output_wrapper((('Verification of message sent by Replica ' + str(sender_id)) + ' has failed.'))
            return
    ...
    _Client_handler_2425._labels = None
    _Client_handler_2425._notlabels = None
