...
PatternExpr_376 = da.pat.BoundPattern('_BoundPattern377_')
PatternExpr_390 = da.pat.ConstantPattern('Shutdown')
PatternExpr_394 = da.pat.FreePattern('olympus')
PatternExpr_408 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('olympus_'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_'), da.pat.FreePattern('tail_'), da.pat.FreePattern('config_data')])
PatternExpr_481 = da.pat.TuplePattern([da.pat.ConstantPattern('Key'), da.pat.FreePattern('private_key_')])
PatternExpr_488 = da.pat.FreePattern('olympus')
PatternExpr_508 = da.pat.TuplePattern([da.pat.ConstantPattern('Client_keys'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_533 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Request'), da.pat.FreePattern('type'), da.pat.FreePattern('request_from'), da.pat.FreePattern('client'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('args')])
PatternExpr_730 = da.pat.BoundPattern('_BoundPattern736_')
PatternExpr_966 = da.pat.BoundPattern('_BoundPattern972_')
PatternExpr_1269 = da.pat.BoundPattern('_BoundPattern1275_')
PatternExpr_1308 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Result_shuttle'), da.pat.FreePattern('request_from'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_378 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern384_')]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_738 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern745_')])
...
PatternExpr_1277 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1284_')])
PatternExpr_2165 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_2184 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_2250 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_2366 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_2389 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2373 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_2393 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_2506 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_')])
PatternExpr_2515 = da.pat.FreePattern('olympus')
PatternExpr_2538 = da.pat.TuplePattern([da.pat.ConstantPattern('Keys'), da.pat.FreePattern('replica_public_keys_'), da.pat.FreePattern('olympus_public_key_')])
PatternExpr_2547 = da.pat.FreePattern('olympus')
PatternExpr_2583 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Operation_result'), da.pat.FreePattern('request_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_2764 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2767_'), da.pat.BoundPattern('_BoundPattern2768_')])
PatternExpr_2818 = da.pat.BoundPattern('_BoundPattern2824_')
PatternExpr_2890 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2771 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2781_'), da.pat.BoundPattern('_BoundPattern2782_')])])
PatternExpr_2826 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern2833_')])
PatternExpr_2894 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
_config_object = {}
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_372, sources=[PatternExpr_376], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_390, sources=[PatternExpr_394], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_389]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_408, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_407]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_481, sources=[PatternExpr_488], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_480]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_508, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_507]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_533, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_532]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_730, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_966, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_1269, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_1308, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_1307])])

    def setup(self, id, name, replica_failures, replica_timeout, olympus_public_key, **rest_3453):
        super().setup(id=id, name=name, replica_failures=replica_failures, replica_timeout=replica_timeout, olympus_public_key=olympus_public_key, **rest_3453)
        self._state.id = id
    ...
    def run(self):
        ...
        while (_st_label_369 == 0):
            _st_label_369 += 1
            if PatternExpr_378.match_iter(self._ReplicaReceivedEvent_0, _BoundPattern384_=self._state.olympus, SELF_ID=self._id):
                _st_label_369 += 1
            else:
    ...
    def _Replica_handler_389(self, olympus):
        self._state.status = 2
        self.output_wrapper((self._state.name + ' is immutable and shutting down.'))
    _Replica_handler_389._labels = None
    _Replica_handler_389._notlabels = None

    def _Replica_handler_407(self, olympus_, replicas_, head_, tail_, config_data):
    ...
    _Replica_handler_407._labels = None
    _Replica_handler_407._notlabels = None

    def _Replica_handler_480(self, private_key_, olympus):
    ...
    def _Replica_handler_507(self, client_id, client_public_key):
    ...
    def _Replica_handler_532(self, sender_id, type, request_from, client, request_id, client_id, args):
        ...
        if (self._state.status == 1):
            if (request_from == client):
                ...
                if (request_id in self._state.result_cache):
                    ...
                    super()._label('_st_label_727', block=False)
                    _st_label_727 = 0
                    self._timer_start()
                    while (_st_label_727 == 0):
                        _st_label_727 += 1
                        if PatternExpr_738.match_iter(self._ReplicaReceivedEvent_6, _BoundPattern745_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                            pass
                            _st_label_727 += 1
                            ...
                            super()._label('_st_label_727', block=True, timeout=self._state.replica_timeout)
                            _st_label_727 -= 1
                    return
            else:
            ...
            if (self._id == self._state.head):
                ...
                while (_st_label_963 == 0):
                    _st_label_963 += 1
                    if PatternExpr_974.match_iter(self._ReplicaReceivedEvent_7, _BoundPattern981_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                        pass
                        _st_label_963 += 1
                    elif self._timer_expired:
                        self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                ...
                if self.validate_shuttle(args):
                    ...
                    if (self._id == self._state.tail):
                        ...
                        while (_st_label_1266 == 0):
                            _st_label_1266 += 1
                            if PatternExpr_1277.match_iter(self._ReplicaReceivedEvent_8, _BoundPattern1284_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                                pass
                                _st_label_1266 += 1
                            elif self._timer_expired:
                                self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                                ...
                                super()._label('_st_label_1266', block=True, timeout=self._state.replica_timeout)
                                _st_label_1266 -= 1
                else:
                    self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_532._labels = None
    _Replica_handler_532._notlabels = None

    def _Replica_handler_1307(self, sender_id, request_from, request_id, client_id, result_shuttle):
        ...
        if self.validate_result_shuttle(result_shuttle):
            ...
            self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_1307._labels = None
    _Replica_handler_1307._notlabels = None
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_2165, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2164]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_2184, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2183]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_2250, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2249]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_2366, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_2389, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, all_replica_conf_failures, head_timeout, replica_timeout, **rest_3453):
        super().setup(name=name, num_replicas=num_replicas, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, **rest_3453)
        self._state.name = name
    ...
    def run(self):
        ...
        super()._label('_st_label_2363', block=False)
        _st_label_2363 = 0
        while (_st_label_2363 == 0):
            _st_label_2363 += 1
            if PatternExpr_2373.match_iter(self._OlympusReceivedEvent_3, SELF_ID=self._id):
                _st_label_2363 += 1
            else:
                super()._label('_st_label_2363', block=True)
                _st_label_2363 -= 1
        super()._label('_st_label_2386', block=False)
        _st_label_2386 = 0
        while (_st_label_2386 == 0):
            _st_label_2386 += 1
            if PatternExpr_2393.match_iter(self._OlympusReceivedEvent_4, SELF_ID=self._id):
                _st_label_2386 += 1
            else:
                super()._label('_st_label_2386', block=True)
                _st_label_2386 -= 1
    ...
    def _Olympus_handler_2164(self, sender):
        self.output_wrapper((('ACK from ' + str(sender)) + '.'))
    _Olympus_handler_2164._labels = None
    _Olympus_handler_2164._notlabels = None

    def _Olympus_handler_2183(self, client, client_name, client_id, client_public_key):
        self._state.client_keys[client_id] = VerifyKey(client_public_key, encoder=HexEncoder)
    ...
    _Olympus_handler_2183._labels = None
    _Olympus_handler_2183._notlabels = None

    def _Olympus_handler_2249(self, sender, proof_of_misbehavior):
    ...
    _Olympus_handler_2249._labels = None
    _Olympus_handler_2249._notlabels = None
...
class Client(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_0', PatternExpr_2506, sources=[PatternExpr_2515], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2505]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_1', PatternExpr_2538, sources=[PatternExpr_2547], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2537]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_2', PatternExpr_2583, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2582]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_3', PatternExpr_2764, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_4', PatternExpr_2818, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_5', PatternExpr_2890, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, client_id, olympus, request_id, client_timeout, operations, num_failures, **rest_3453):
        super().setup(client_id=client_id, olympus=olympus, request_id=request_id, client_timeout=client_timeout, operations=operations, num_failures=num_failures, **rest_3453)
    ...
    def run(self):
        if (self._state.replicas is None):
            ...
            super()._label('_st_label_2761', block=False)
            _st_label_2761 = 0
            while (_st_label_2761 == 0):
                _st_label_2761 += 1
                if PatternExpr_2771.match_iter(self._ClientReceivedEvent_3, _BoundPattern2781_=self._state.replicas, _BoundPattern2782_=self._state.head, SELF_ID=self._id):
                    _st_label_2761 += 1
                else:
                    super()._label('_st_label_2761', block=True)
                    _st_label_2761 -= 1
        for op in self._state.operations:
            ...
            while True:
                ...
                super()._label('_st_label_2815', block=False)
                _st_label_2815 = 0
                self._timer_start()
                while (_st_label_2815 == 0):
                    _st_label_2815 += 1
                    if PatternExpr_2826.match_iter(self._ClientReceivedEvent_4, _BoundPattern2833_=('Operation_result_' + str(self._state.request_id)), SELF_ID=self._id):
                        break
                        _st_label_2815 += 1
                    elif self._timer_expired:
                        ...
                        super()._label('_st_label_2815', block=True, timeout=self._state.client_timeout)
                        _st_label_2815 -= 1
                else:
                    if (_st_label_2815 != 2):
                        continue
        ...
        super()._label('_st_label_2887', block=False)
        _st_label_2887 = 0
        while (_st_label_2887 == 0):
            _st_label_2887 += 1
            if PatternExpr_2894.match_iter(self._ClientReceivedEvent_5, SELF_ID=self._id):
                _st_label_2887 += 1
            else:
                super()._label('_st_label_2887', block=True)
                _st_label_2887 -= 1
    ...
    def _Client_handler_2505(self, replicas_, head_, olympus):
        self._state.replicas = replicas_
        self._state.head = head_
        self.output_wrapper((self._state.name + ' is configured.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2505._labels = None
    _Client_handler_2505._notlabels = None

    def _Client_handler_2537(self, replica_public_keys_, olympus_public_key_, olympus):
        self._state.replica_public_keys = [VerifyKey(key, encoder=HexEncoder) for key in replica_public_keys_]
        ...
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2537._labels = None
    _Client_handler_2537._notlabels = None

    def _Client_handler_2582(self, sender_id, request_id, result_shuttle):
        result_shuttle = self.verify_data_with_key(result_shuttle, self._state.replica_public_keys[sender_id])
        if (result_shuttle == None):
            self.output_wrapper((('Verification of message sent by Replica ' + str(sender_id)) + ' has failed.'))
            return
    ...
    _Client_handler_2582._labels = None
    _Client_handler_2582._notlabels = None
