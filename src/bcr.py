# -*- generated by 1.0.9 -*-
import da
PatternExpr_350 = da.pat.ConstantPattern('Shutdown')
PatternExpr_354 = da.pat.BoundPattern('_BoundPattern355_')
PatternExpr_368 = da.pat.ConstantPattern('Shutdown')
PatternExpr_372 = da.pat.FreePattern('olympus')
PatternExpr_384 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('olympus_'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_'), da.pat.FreePattern('tail_'), da.pat.FreePattern('config_data')])
PatternExpr_453 = da.pat.TuplePattern([da.pat.ConstantPattern('Key'), da.pat.FreePattern('private_key_')])
PatternExpr_460 = da.pat.FreePattern('olympus')
PatternExpr_478 = da.pat.TuplePattern([da.pat.ConstantPattern('Client_keys'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_503 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Request'), da.pat.FreePattern('type'), da.pat.FreePattern('request_from'), da.pat.FreePattern('client'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('args')])
PatternExpr_680 = da.pat.BoundPattern('_BoundPattern686_')
PatternExpr_888 = da.pat.BoundPattern('_BoundPattern894_')
PatternExpr_1164 = da.pat.BoundPattern('_BoundPattern1170_')
PatternExpr_1203 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Result_shuttle'), da.pat.FreePattern('request_from'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_356 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern362_')]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_688 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern695_')])
...
PatternExpr_1172 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1179_')])
PatternExpr_1971 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.FreePattern('sender')])
PatternExpr_1988 = da.pat.TuplePattern([da.pat.ConstantPattern('Get_configuration'), da.pat.FreePattern('client'), da.pat.FreePattern('client_name'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_2039 = da.pat.TuplePattern([da.pat.ConstantPattern('Reconfiguration'), da.pat.FreePattern('sender'), da.pat.FreePattern('proof_of_misbehavior')])
PatternExpr_2151 = da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])
PatternExpr_2174 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2158 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('ACK'), da.pat.ConstantPattern(None)])])
PatternExpr_2178 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_2271 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_')])
PatternExpr_2280 = da.pat.FreePattern('olympus')
PatternExpr_2301 = da.pat.TuplePattern([da.pat.ConstantPattern('Keys'), da.pat.FreePattern('replica_public_keys_')])
PatternExpr_2308 = da.pat.FreePattern('olympus')
PatternExpr_2334 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Operation_result'), da.pat.FreePattern('result_shuttle')])
PatternExpr_2504 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2507_'), da.pat.BoundPattern('_BoundPattern2508_')])
PatternExpr_2558 = da.pat.BoundPattern('_BoundPattern2564_')
PatternExpr_2605 = da.pat.ConstantPattern('Shutdown')
PatternExpr_2511 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.BoundPattern('_BoundPattern2521_'), da.pat.BoundPattern('_BoundPattern2522_')])])
PatternExpr_2566 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern2573_')])
PatternExpr_2609 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.ConstantPattern('Shutdown')])
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_350, sources=[PatternExpr_354], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_368, sources=[PatternExpr_372], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_367]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_384, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_383]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_453, sources=[PatternExpr_460], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_452]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_478, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_477]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_503, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_502]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_680, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_888, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_1164, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_1203, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_1202])])

    def setup(self, id, name, replica_failures, replica_timeout, olympus_public_key, **rest_3100):
        super().setup(id=id, name=name, replica_failures=replica_failures, replica_timeout=replica_timeout, olympus_public_key=olympus_public_key, **rest_3100)
        self._state.id = id
    ...
    def run(self):
        ...
        while (_st_label_347 == 0):
            _st_label_347 += 1
            if PatternExpr_356.match_iter(self._ReplicaReceivedEvent_0, _BoundPattern362_=self._state.olympus, SELF_ID=self._id):
                _st_label_347 += 1
            else:
    ...
    def _Replica_handler_367(self, olympus):
    ...
    def _Replica_handler_383(self, olympus_, replicas_, head_, tail_, config_data):
        ...
        if (config_data == None):
            self.output('Verification of message sent by Olympus has failed.')
            return
    ...
    def _Replica_handler_452(self, private_key_, olympus):
    ...
    def _Replica_handler_477(self, client_id, client_public_key):
    ...
    def _Replica_handler_502(self, sender_id, type, request_from, client, request_id, client_id, args):
            ...
            if (request_from == client):
                ...
                if (request_id in self._state.result_cache):
                    ...
                    while (_st_label_677 == 0):
                        _st_label_677 += 1
                        if PatternExpr_688.match_iter(self._ReplicaReceivedEvent_6, _BoundPattern695_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                            pass
                            _st_label_677 += 1
                            ...
                            super()._label('_st_label_677', block=True, timeout=self._state.replica_timeout)
                            _st_label_677 -= 1
                    return
            else:
                ...
                if self.validate_shuttle(args):
                    ...
                    if (self._id == self._state.tail):
                        ...
                        while (_st_label_1161 == 0):
                            _st_label_1161 += 1
                            if PatternExpr_1172.match_iter(self._ReplicaReceivedEvent_8, _BoundPattern1179_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                                pass
                                _st_label_1161 += 1
                            elif self._timer_expired:
                                self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
                                ...
                                super()._label('_st_label_1161', block=True, timeout=self._state.replica_timeout)
                                _st_label_1161 -= 1
                else:
                    self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_502._labels = None
    _Replica_handler_502._notlabels = None

    def _Replica_handler_1202(self, sender_id, request_from, request_id, client_id, result_shuttle):
        ...
        if self.validate_result_shuttle(result_shuttle):
            ...
            self.send(('Reconfiguration', self._state.name, None), to=self._state.olympus)
    _Replica_handler_1202._labels = None
    _Replica_handler_1202._notlabels = None
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_1971, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1970]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_1988, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1987]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_2039, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_2038]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_2151, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_2174, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, name, num_replicas, all_replica_conf_failures, head_timeout, replica_timeout, **rest_3100):
        super().setup(name=name, num_replicas=num_replicas, all_replica_conf_failures=all_replica_conf_failures, head_timeout=head_timeout, replica_timeout=replica_timeout, **rest_3100)
        self._state.name = name
    ...
    def run(self):
        ...
        super()._label('_st_label_2148', block=False)
        _st_label_2148 = 0
        while (_st_label_2148 == 0):
            _st_label_2148 += 1
            if PatternExpr_2158.match_iter(self._OlympusReceivedEvent_3, SELF_ID=self._id):
                _st_label_2148 += 1
            else:
                super()._label('_st_label_2148', block=True)
                _st_label_2148 -= 1
        super()._label('_st_label_2171', block=False)
        _st_label_2171 = 0
        while (_st_label_2171 == 0):
            _st_label_2171 += 1
            if PatternExpr_2178.match_iter(self._OlympusReceivedEvent_4, SELF_ID=self._id):
                _st_label_2171 += 1
            else:
                super()._label('_st_label_2171', block=True)
                _st_label_2171 -= 1
    ...
    def _Olympus_handler_1970(self, sender):
        self.output((('ACK from ' + str(sender)) + '.'))
    _Olympus_handler_1970._labels = None
    _Olympus_handler_1970._notlabels = None

    def _Olympus_handler_1987(self, client, client_name, client_id, client_public_key):
        self._state.client_keys[client_id] = VerifyKey(client_public_key, encoder=HexEncoder)
    ...
    _Olympus_handler_1987._labels = None
    _Olympus_handler_1987._notlabels = None

    def _Olympus_handler_2038(self, sender, proof_of_misbehavior):
        self.output((('Reconfiguration request received from ' + str(sender)) + '.'))
        self.output('No reconfiguration mechanism implemented yet.')
    _Olympus_handler_2038._labels = None
    _Olympus_handler_2038._notlabels = None
...
class Client(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_0', PatternExpr_2271, sources=[PatternExpr_2280], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2270]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_1', PatternExpr_2301, sources=[PatternExpr_2308], destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2300]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_2', PatternExpr_2334, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Client_handler_2333]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_3', PatternExpr_2504, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_4', PatternExpr_2558, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ClientReceivedEvent_5', PatternExpr_2605, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])

    def setup(self, client_id, olympus, request_id, client_timeout, operations, num_failures, **rest_3100):
        super().setup(client_id=client_id, olympus=olympus, request_id=request_id, client_timeout=client_timeout, operations=operations, num_failures=num_failures, **rest_3100)
    ...
    def run(self):
        if (self._state.replicas is None):
            ...
            super()._label('_st_label_2501', block=False)
            _st_label_2501 = 0
            while (_st_label_2501 == 0):
                _st_label_2501 += 1
                if PatternExpr_2511.match_iter(self._ClientReceivedEvent_3, _BoundPattern2521_=self._state.replicas, _BoundPattern2522_=self._state.head, SELF_ID=self._id):
                    _st_label_2501 += 1
                else:
                    super()._label('_st_label_2501', block=True)
                    _st_label_2501 -= 1
        for op in self._state.operations:
            ...
            while True:
                ...
                super()._label('_st_label_2555', block=False)
                _st_label_2555 = 0
                self._timer_start()
                while (_st_label_2555 == 0):
                    _st_label_2555 += 1
                    if PatternExpr_2566.match_iter(self._ClientReceivedEvent_4, _BoundPattern2573_=('Operation_result_' + str(self._state.request_id)), SELF_ID=self._id):
                        break
                        _st_label_2555 += 1
                    elif self._timer_expired:
                        ...
                        super()._label('_st_label_2555', block=True, timeout=self._state.client_timeout)
                        _st_label_2555 -= 1
                else:
                    if (_st_label_2555 != 2):
                        continue
                if (_st_label_2555 != 2):
                    break
        self.output((('Local running state of client after the given set of operations: ' + str(self._state.client_running_state)) + '.'))
        self.output((('Running state of client at the server (assuming no conflicting keys from other clients) after the given set of operations: ' + str(self._state.client_running_state_sync)) + '.'))
        super()._label('_st_label_2602', block=False)
        _st_label_2602 = 0
        while (_st_label_2602 == 0):
            _st_label_2602 += 1
            if PatternExpr_2609.match_iter(self._ClientReceivedEvent_5, SELF_ID=self._id):
                _st_label_2602 += 1
            else:
                super()._label('_st_label_2602', block=True)
                _st_label_2602 -= 1
    ...
    def _Client_handler_2270(self, replicas_, head_, olympus):
        self._state.replicas = replicas_
        self._state.head = head_
        self.output((self._state.name + ' is configured.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2270._labels = None
    _Client_handler_2270._notlabels = None

    def _Client_handler_2300(self, replica_public_keys_, olympus):
        self._state.replica_public_keys = [VerifyKey(key, encoder=HexEncoder) for key in replica_public_keys_]
        self.output((self._state.name + ' received the public keys of replicas from Olympus.'))
        self.send(('ACK', self._state.name), to=olympus)
    _Client_handler_2300._labels = None
    _Client_handler_2300._notlabels = None

    def _Client_handler_2333(self, sender_id, result_shuttle):
        result_shuttle = self.verify_data_with_key(result_shuttle, self._state.replica_public_keys[sender_id])
        if (result_shuttle == None):
            self.output((('Verification of message sent by Replica ' + str(sender_id)) + ' has failed.'))
            return
    ...
    _Client_handler_2333._labels = None
    _Client_handler_2333._notlabels = None
