# -*- generated by 1.0.10 -*-
import da
PatternExpr_455 = da.pat.ConstantPattern('Shutdown')
PatternExpr_459 = da.pat.BoundPattern('_BoundPattern460_')
PatternExpr_473 = da.pat.ConstantPattern('Shutdown')
PatternExpr_477 = da.pat.FreePattern('olympus')
PatternExpr_494 = da.pat.TuplePattern([da.pat.ConstantPattern('Configuration'), da.pat.FreePattern('olympus_'), da.pat.FreePattern('replicas_'), da.pat.FreePattern('head_'), da.pat.FreePattern('tail_'), da.pat.FreePattern('config_data')])
PatternExpr_693 = da.pat.TuplePattern([da.pat.ConstantPattern('Key'), da.pat.FreePattern('private_key_')])
PatternExpr_700 = da.pat.FreePattern('olympus')
PatternExpr_720 = da.pat.TuplePattern([da.pat.ConstantPattern('Client_keys'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_public_key')])
PatternExpr_758 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Request'), da.pat.FreePattern('type'), da.pat.FreePattern('request_from'), da.pat.FreePattern('client'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('client_args'), da.pat.FreePattern('args')])
PatternExpr_1157 = da.pat.BoundPattern('_BoundPattern1163_')
PatternExpr_1674 = da.pat.BoundPattern('_BoundPattern1680_')
PatternExpr_2304 = da.pat.BoundPattern('_BoundPattern2310_')
PatternExpr_2428 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Checkpoint_proof'), da.pat.FreePattern('args')])
PatternExpr_2839 = da.pat.TuplePattern([da.pat.FreePattern('sender_id'), da.pat.ConstantPattern('Result_shuttle'), da.pat.FreePattern('request_from'), da.pat.FreePattern('request_id'), da.pat.FreePattern('client_id'), da.pat.FreePattern('result_shuttle')])
PatternExpr_3210 = da.pat.ConstantPattern('wedge_request')
PatternExpr_3214 = da.pat.FreePattern('olympus')
PatternExpr_3431 = da.pat.TuplePattern([da.pat.ConstantPattern('catch_up'), da.pat.FreePattern('gap')])
PatternExpr_3438 = da.pat.FreePattern('olympus')
PatternExpr_3630 = da.pat.ConstantPattern('get_running_state')
PatternExpr_3634 = da.pat.FreePattern('olympus')
PatternExpr_3774 = da.pat.TuplePattern([da.pat.ConstantPattern('get_running_state'), da.pat.FreePattern('client'), da.pat.FreePattern('requests_')])
PatternExpr_461 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.BoundPattern('_BoundPattern467_')]), da.pat.ConstantPattern('Shutdown')])
PatternExpr_1165 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1172_')])
PatternExpr_1682 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern1689_')])
PatternExpr_2312 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.BoundPattern('_BoundPattern2319_')])
...
class Replica(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_0', PatternExpr_455, sources=[PatternExpr_459], destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_1', PatternExpr_473, sources=[PatternExpr_477], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_472]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_2', PatternExpr_494, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_493]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_3', PatternExpr_693, sources=[PatternExpr_700], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_692]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_4', PatternExpr_720, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_719]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_5', PatternExpr_758, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_757]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_6', PatternExpr_1157, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_7', PatternExpr_1674, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_8', PatternExpr_2304, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_9', PatternExpr_2428, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2427]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_10', PatternExpr_2839, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_2838]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_11', PatternExpr_3210, sources=[PatternExpr_3214], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3209]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_12', PatternExpr_3431, sources=[PatternExpr_3438], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3430]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_13', PatternExpr_3630, sources=[PatternExpr_3634], destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3629]), da.pat.EventPattern(da.pat.ReceivedEvent, '_ReplicaReceivedEvent_14', PatternExpr_3774, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._Replica_handler_3773])])

    def setup(self, id, name, running_state, replica_failures, replica_timeout, olympus_public_key, checkpt_interval, slot_number, **rest_4590):
        super().setup(id=id, name=name, running_state=running_state, replica_failures=replica_failures, replica_timeout=replica_timeout, olympus_public_key=olympus_public_key, checkpt_interval=checkpt_interval, slot_number=slot_number, **rest_4590)
        self._state.id = id
    ...
    def run(self):
        ...
        while (_st_label_452 == 0):
            _st_label_452 += 1
            if PatternExpr_461.match_iter(self._ReplicaReceivedEvent_0, _BoundPattern467_=self._state.olympus, SELF_ID=self._id):
                _st_label_452 += 1
            else:
    ...
    def corrupt_sign_and_send(self, data, type_to_corrupt, send_to):
        if (type_to_corrupt == 'order'):
            pass
        elif (type_to_corrupt == 'result'):
            pass
        self.sign_and_send(data, send_to)

    def output_wrapper(self, log):
        self.output('[TS: {}][{}]'.format(str(time()), self._state.name), log)

    def _Replica_handler_472(self, olympus):
        self.output_wrapper((((self._state.name + " is now shutting down.\nIt's final running state is:\n") + str(self._state.running_state)) + '.\n'))
    _Replica_handler_472._labels = None
    _Replica_handler_472._notlabels = None

    def _Replica_handler_493(self, olympus_, replicas_, head_, tail_, config_data):
    ...
    _Replica_handler_493._labels = None
    _Replica_handler_493._notlabels = None

    def _Replica_handler_692(self, private_key_, olympus):
    ...
    def _Replica_handler_719(self, client_id, client_public_key):
        ...
        self.send(('ACK', self._state.name), to=self._state.olympus)
    _Replica_handler_719._labels = None
    _Replica_handler_719._notlabels = None

    def _Replica_handler_757(self, sender_id, type, request_from, client, request_id, client_id, client_args, args):
        ...
        if (request_from == client):
            ...
            if (request_id in self._state.result_cache):
                ...
                super()._label('_st_label_1154', block=False)
                _st_label_1154 = 0
                self._timer_start()
                while (_st_label_1154 == 0):
                    _st_label_1154 += 1
                    if PatternExpr_1165.match_iter(self._ReplicaReceivedEvent_6, _BoundPattern1172_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                        ...
                        super()._label('_st_label_1154', block=True, timeout=self._state.replica_timeout)
                        _st_label_1154 -= 1
                return
        else:
        ...
        if self.is_head():
            ...
            if ((FailureActionType.invalid_order_sig in self._state.pending_failures) and (self._state.pending_failures[FailureActionType.invalid_order_sig] == 1)):
                ...
                self.corrupt_sign_and_send(('Request', type, self._id, client, request_id, client_id, client_args, shuttle), 'order', self._state.replicas.get((self._state.id + 1)))
                ...
                self.corrupt_sign_and_send(('Request', type, self._id, client, request_id, client_id, client_args, shuttle), 'result', self._state.replicas.get((self._state.id + 1)))
            ...
            self._state.last_slot_number = self._state.slot_number
            super()._label('_st_label_1671', block=False)
            _st_label_1671 = 0
            self._timer_start()
            while (_st_label_1671 == 0):
                _st_label_1671 += 1
                if PatternExpr_1682.match_iter(self._ReplicaReceivedEvent_7, _BoundPattern1689_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                    self._state.ongoing_request_id = None
                    _st_label_1671 += 1
                elif self._timer_expired:
                    ...
                    super()._label('_st_label_1671', block=True, timeout=self._state.replica_timeout)
                    _st_label_1671 -= 1
        else:
            ...
            if self.is_tail():
                ...
                if ((FailureActionType.invalid_result_sig in self._state.pending_failures) and (self._state.pending_failures[FailureActionType.invalid_result_sig] == 1)):
                    ...
                    self.corrupt_sign_and_send(('Operation_result', request_id, result_shuttle), 'result', client)
                    self._state.pending_failures[FailureActionType.invalid_result_sig] = 0
                    self._state.pending_failure_scenarios[FailureActionType.invalid_result_sig] = None
                else:
                ...
                while (_st_label_2301 == 0):
                    _st_label_2301 += 1
                    if PatternExpr_2312.match_iter(self._ReplicaReceivedEvent_8, _BoundPattern2319_=('Result_shuttle_' + str(request_id)), SELF_ID=self._id):
                        pass
                        _st_label_2301 += 1
                    elif self._timer_expired:
                        ...
                        super()._label('_st_label_2301', block=True, timeout=self._state.replica_timeout)
                        _st_label_2301 -= 1
    _Replica_handler_757._labels = None
    _Replica_handler_757._notlabels = None

    def _Replica_handler_2427(self, sender_id, args):
        self.check_all_failures(None)
        failure_list = [FailureActionType.crash, FailureActionType.sleep, FailureActionType.drop]
        if (self.exec_failures(failure_list) == 1):
            return
    ...
    _Replica_handler_2427._labels = None
    _Replica_handler_2427._notlabels = None

    def _Replica_handler_2838(self, sender_id, request_from, request_id, client_id, result_shuttle):
        self.check_all_failures(client_id)
        failure_list = [FailureActionType.crash, FailureActionType.sleep, FailureActionType.drop]
        if (self.exec_failures(failure_list) == 1):
            return
        ...
        if self.validate_result_shuttle(result_shuttle):
            ...
            self.send(('Reconfiguration', self._state.name, self._state.configuration), to=self._state.olympus)
            return
    _Replica_handler_2838._labels = None
    _Replica_handler_2838._notlabels = None

    def _Replica_handler_3209(self, olympus):
        ...
        if self.is_head():
            if ((FailureActionType.increment_slot in self._state.pending_failures) and (self._state.pending_failures[FailureActionType.increment_slot] == 1)):
                ...
                self._state.pending_failures[FailureActionType.increment_slot] = 0
                self._state.pending_failure_scenarios[FailureActionType.increment_slot] = None
        history_to_send = self._state.history[:]
    ...
    _Replica_handler_3209._labels = None
    _Replica_handler_3209._notlabels = None

    def _Replica_handler_3430(self, gap, olympus):
        self.check_all_failures(None)
        failure_list = [FailureActionType.crash, FailureActionType.sleep, FailureActionType.drop]
        if (self.exec_failures(failure_list) == 1):
            return
    ...
    def _Replica_handler_3629(self, olympus):
        self.check_all_failures(None)
        failure_list = [FailureActionType.crash, FailureActionType.sleep, FailureActionType.drop]
        if (self.exec_failures(failure_list) == 1):
            return
    ...
    _Replica_handler_3629._labels = None
    _Replica_handler_3629._notlabels = None

    def _Replica_handler_3773(self, client, requests_):
        self.send(('running_state', self._state.running_state), to=client)
        self.send(('running_state_' + str(requests_)), to=client)
    _Replica_handler_3773._labels = None
    _Replica_handler_3773._notlabels = None
